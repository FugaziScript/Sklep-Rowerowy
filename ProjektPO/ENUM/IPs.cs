...
namespace Projekt_PO {
    ...
    public enum IPs { //Typ wyliczeniowy z normą IP
        IP00, IPO1, IP02, IP03, IP04, IP05, IP06, IP07, IP08, IP09,
    ...
    //Uwaga: W celu poprawnego wyświetlenia należy skorzystać z funkcji tostr.IP2str(IP)
}
